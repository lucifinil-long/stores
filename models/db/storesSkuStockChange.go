...
type StoresSkuStockChange struct {
	...
	SkuId       int64     `json:"sku_id" xorm:"not null index BIGINT(20)"`
	ShelfId     int64     `json:"shelf_id" xorm:"not null index BIGINT(20)"`
	Amount      int64     `json:"amount" xorm:"not null default 0 BIGINT(20)"`
	Type        int       `json:"type" xorm:"not null TINYINT(4)"`
	OperatorId  int64     `json:"operator_id" xorm:"not null index BIGINT(20)"`
